...
def animation():
    ...
    if stop:
        ...
        if obstacles.y < 0 or dis == True:
            ...
            obstacles.x = random.randint(30, 70)
            obstacles.y = 105
            dis = False
        if obstacles2.y < 0 or dis3 == True: #dummy obstacle
            # once_neg = True
            # felled = True
            # obstacles_speed += .01
                
            obstacles2.x = random.randint(30, 70)
            obstacles2.y = 105
            dis3 = False
 
        if obstacles3.y < 0 or dis4 == True: #dummy obstacle
            # once_neg = True
            # felled = True
            # obstacles_speed += .01
                
            obstacles3.x = random.randint(30, 70)
            obstacles3.y = 105
            dis4 = False
        ...
        if diamond.y < diamon_dis or dis2 == True:
            ...
            diamond.x = random.randint(30, 70)
            diamond.y = 1000
            dis2 = False
        ...
        collision2 = collides_with_sq_obstacle(car_position, 4, 8, obstacles2) #dummy obstacle
        collision3 = collides_with_sq_obstacle(car_position, 4, 8, obstacles3) #dummy obstacle
        if collision == True:
            #print(var)
            #var +=1
            collision = False
...
def main():
    ...
    glutCreateWindow(b"Midpoint Line Algorithm")
